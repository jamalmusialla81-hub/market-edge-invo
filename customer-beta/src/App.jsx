...
function TradeView({ scan, scanning, error, onScan, onTake, taken, onSettings, selected, onSelect }) {
  ...
  return <main className="trade-view"><section className="scanner-toolbar"><div><span className="eyebrow">Market Edge / Scanner</span><h2>Live market scanner</h2><p>Server-ranked opportunities across the verified Invo universe.</p></div><div className="hero-actions"><ScanButton scanning={scanning} onClick={onScan}/><span className="allowance">Manual execution · Scan allowance enforcement pending</span></div></section>
