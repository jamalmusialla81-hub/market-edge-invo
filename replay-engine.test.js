...
const cache=Replay.derived(base);for(const at of [base[17_280].time+M5,base[17_610].time+M5,asOf]){const old=Replay.snapshot(base,at),fast=Replay.cachedSnapshot(cache,at);assert.deepEqual(fast.timeframes,old.timeframes);}
