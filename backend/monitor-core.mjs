...
export const COINBASE_PRODUCTS={BTC:'BTC-USD',ETH:'ETH-USD',SOL:'SOL-USD',XRP:'XRP-USD',DOGE:'DOGE-USD',LTC:'LTC-USD',ADA:'ADA-USD',AVAX:'AVAX-USD',LINK:'LINK-USD',SUI:'SUI-USD',BCH:'BCH-USD',AAVE:'AAVE-USD',ICP:'ICP-USD'};
