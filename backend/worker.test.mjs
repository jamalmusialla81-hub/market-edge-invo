...
assert.equal(scheduled.replay.status,'PENDING');assert.equal(scheduled.scheduledScope.replayBudget,'one asset / 288 completed 5m candles');assert.deepEqual(scheduled.scheduledScope.monitorAssets,['BTC']);
